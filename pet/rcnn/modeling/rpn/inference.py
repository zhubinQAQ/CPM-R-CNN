...
from pet.utils.data.structures.boxlist_ops import boxlist_nms
from pet.utils.data.structures.boxlist_ops import remove_small_boxes
from pet.rcnn.utils.box_coder import BoxCoder
from pet.rcnn.utils.misc import permute_and_flatten, cat
...
def make_rpn_postprocessor(rpn_box_coder, is_train):
    fpn_post_nms_top_n = cfg.RPN.FPN_POST_NMS_TOP_N_TRAIN
    if not is_train:
        fpn_post_nms_top_n = cfg.RPN.FPN_POST_NMS_TOP_N_TEST

    pre_nms_top_n = cfg.RPN.PRE_NMS_TOP_N_TRAIN
    post_nms_top_n = cfg.RPN.POST_NMS_TOP_N_TRAIN
    if not is_train:
        pre_nms_top_n = cfg.RPN.PRE_NMS_TOP_N_TEST
        post_nms_top_n = cfg.RPN.POST_NMS_TOP_N_TEST
    fpn_post_nms_per_batch = cfg.RPN.FPN_POST_NMS_PER_BATCH

...
def make_anchor_generator():
    ...
    straddle_thresh = cfg.RPN.STRADDLE_THRESH
...
def make_anchor_generator_retinanet():
    anchor_sizes = cfg.RETINANET.ANCHOR_SIZES
    aspect_ratios = cfg.RETINANET.ASPECT_RATIOS
    anchor_strides = cfg.RETINANET.ANCHOR_STRIDES
    straddle_thresh = cfg.RETINANET.STRADDLE_THRESH
    octave = cfg.RETINANET.OCTAVE

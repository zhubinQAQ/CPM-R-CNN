...
from pet.lib.datasets.structures.image_list import to_image_list, ImageList
from pet.lib.datasets.structures.bounding_box import BoxList
...
class Analyser:
    ...
    Usage:
        from pet.{task}.modeling.model_builder import Generalized_CNN(SSD)
